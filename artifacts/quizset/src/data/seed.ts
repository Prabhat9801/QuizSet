...
export const questions: Question[] = [
  ...
  { id: 'q-pct-1', questionBankId: 'qb-ssc-cgl', text: 'The price of an article is ₹500. It increases by 20%. What is the new price?', options: ['₹550', '₹580', '₹600', '₹620'], answer: 2, explanation: '20% of ₹500 is ₹100. Add it to the original price: ₹500 + ₹100 = ₹600.', unit: 'Quantitative Aptitude', topic: 'Percentage', difficulty: 'Easy' },
  { id: 'q-pct-2', questionBankId: 'qb-ssc-cgl', text: 'In an election with only two candidates and 20,000 total votes, the winner got 55%. How many votes did the loser get?', options: ['8,000', '8,500', '9,000', '9,500'], answer: 2, explanation: 'Winner: 55% of 20,000 = 11,000. Loser: 20,000 − 11,000 = 9,000.', unit: 'Quantitative Aptitude', topic: 'Percentage', difficulty: 'Medium' },
  { id: 'q-pct-3', questionBankId: 'qb-banking-quant', text: 'A number is first decreased by 25%, then the result is increased by 25%. What is the net percentage change?', options: ['−6.25%', '0%', '+6.25%', '−12.5%'], answer: 0, explanation: 'Let the number be 100. After a 25% decrease: 75. After a 25% increase on 75: 75 × 1.25 = 93.75. Net change = 93.75 − 100 = −6.25%.', unit: 'Quantitative Aptitude', topic: 'Percentage', difficulty: 'Hard' },
  { id: 'q-pl-1', questionBankId: 'qb-ssc-cgl', text: 'A trader buys an article for ₹800 and sells it for ₹960. What is the profit percentage?', options: ['15%', '18%', '20%', '25%'], answer: 2, explanation: 'Profit = ₹960 − ₹800 = ₹160. Profit% = (160 / 800) × 100 = 20%.', unit: 'Quantitative Aptitude', topic: 'Profit & Loss', difficulty: 'Easy' },
  ...
  { id: 'q-pl-3', questionBankId: 'qb-banking-quant', text: 'By selling an article for ₹450, a man loses 10%. What was the cost price?', options: ['₹480', '₹490', '₹500', '₹520'], answer: 2, explanation: 'SP = 0.9 × CP, so CP = 450 / 0.9 = ₹500.', unit: 'Quantitative Aptitude', topic: 'Profit & Loss', difficulty: 'Medium' },
  { id: 'q-tw-1', questionBankId: 'qb-ssc-cgl', text: 'A can finish a piece of work in 12 days and B can finish it in 18 days. Working together, how many days will they take?', options: ['6 days', '7.2 days', '8 days', '9 days'], answer: 1, explanation: 'Combined rate = 1/12 + 1/18 = 5/36 of the work per day, so time taken = 36/5 = 7.2 days.', unit: 'Quantitative Aptitude', topic: 'Time & Work', difficulty: 'Medium' },
  { id: 'q-tw-2', questionBankId: 'qb-banking-quant', text: '12 men can complete a job in 8 days. How many days will 16 men take to complete the same job?', options: ['5 days', '6 days', '7 days', '8 days'], answer: 1, explanation: 'Total work = 12 × 8 = 96 man-days. Time for 16 men = 96 / 16 = 6 days.', unit: 'Quantitative Aptitude', topic: 'Time & Work', difficulty: 'Easy' },
  { id: 'q-ratio-1', questionBankId: 'qb-ssc-cgl', text: 'The ratio of two numbers is 3:5 and their sum is 64. Find the smaller number.', options: ['18', '20', '24', '28'], answer: 2, explanation: 'Total parts = 3 + 5 = 8. One part = 64 / 8 = 8. Smaller number = 3 × 8 = 24.', unit: 'Quantitative Aptitude', topic: 'Ratio', difficulty: 'Medium' },
  { id: 'q-ratio-2', questionBankId: 'qb-banking-quant', text: 'Two numbers are in the ratio 4:7. If their sum is 99, find the larger number.', options: ['56', '63', '70', '77'], answer: 1, explanation: 'Total parts = 4 + 7 = 11. One part = 99 / 11 = 9. Larger number = 7 × 9 = 63.', unit: 'Quantitative Aptitude', topic: 'Ratio', difficulty: 'Easy' },
  { id: 'q-td-1', questionBankId: 'qb-ssc-cgl', text: 'A train travels 360 km in 4 hours. What is its average speed?', options: ['80 km/h', '90 km/h', '100 km/h', '120 km/h'], answer: 1, explanation: 'Average speed = distance ÷ time = 360 ÷ 4 = 90 km/h.', unit: 'Quantitative Aptitude', topic: 'Time & Distance', difficulty: 'Easy' },
  { id: 'q-td-2', questionBankId: 'qb-banking-quant', text: 'A car covers 150 km at 50 km/h and returns the same distance at 75 km/h. Find its average speed for the whole trip.', options: ['55 km/h', '58 km/h', '60 km/h', '62.5 km/h'], answer: 2, explanation: 'Average speed for equal distances = (2 × v1 × v2) / (v1 + v2) = (2 × 50 × 75) / 125 = 60 km/h.', unit: 'Quantitative Aptitude', topic: 'Time & Distance', difficulty: 'Hard' },
  { id: 'q-si-1', questionBankId: 'qb-banking-quant', text: 'Find the simple interest on ₹8,000 at 10% per annum for 3 years.', options: ['₹2,000', '₹2,200', '₹2,400', '₹2,600'], answer: 2, explanation: 'SI = (P × R × T) / 100 = (8000 × 10 × 3) / 100 = ₹2,400.', unit: 'Quantitative Aptitude', topic: 'Simple Interest', difficulty: 'Easy' },
  { id: 'q-avg-1', questionBankId: 'qb-ssc-cgl', text: 'The average of 5 numbers is 42. If one number is excluded, the average of the remaining 4 becomes 40. Find the excluded number.', options: ['40', '45', '50', '55'], answer: 2, explanation: 'Sum of 5 numbers = 5 × 42 = 210. Sum of remaining 4 = 4 × 40 = 160. Excluded number = 210 − 160 = 50.', unit: 'Quantitative Aptitude', topic: 'Average', difficulty: 'Medium' },
  { id: 'q-frac-1', questionBankId: 'qb-banking-quant', text: 'Convert 0.75 into a fraction in its lowest terms.', options: ['1/2', '2/3', '3/4', '4/5'], answer: 2, explanation: '0.75 = 75/100, which simplifies to 3/4.', unit: 'Quantitative Aptitude', topic: 'Number System', difficulty: 'Easy' },
  { id: 'q-unit-1', questionBankId: 'qb-banking-quant', text: "A train's speed is 72 km/h. What is its speed in metres per second?", options: ['15 m/s', '18 m/s', '20 m/s', '25 m/s'], answer: 2, explanation: 'To convert km/h to m/s, multiply by 5/18: 72 × 5/18 = 20 m/s.', unit: 'Quantitative Aptitude', topic: 'Time & Distance', difficulty: 'Easy' },

  // -- Reasoning --
  { id: 'q-ns-1', questionBankId: 'qb-ssc-cgl', text: 'Which number should replace the question mark: 3, 9, 27, 81, ?', options: ['162', '189', '243', '324'], answer: 2, explanation: 'Each term is multiplied by 3 to get the next: 81 × 3 = 243.', unit: 'Reasoning', topic: 'Number Series', difficulty: 'Medium' },
  { id: 'q-ns-2', questionBankId: 'qb-ssc-practice', text: 'Find the odd one out: 27, 64, 125, 150.', options: ['27', '64', '125', '150'], answer: 3, explanation: '27, 64 and 125 are perfect cubes (3³, 4³, 5³). 150 is not a perfect cube.', unit: 'Reasoning', topic: 'Number Series', difficulty: 'Medium' },
  { id: 'q-ls-1', questionBankId: 'qb-ssc-practice', text: 'Find the next term in the series: A, C, F, J, O, ?', options: ['T', 'U', 'V', 'W'], answer: 1, explanation: 'The gaps between letters increase by one each time: +2, +3, +4, +5, +6. O + 6 letters = U.', unit: 'Reasoning', topic: 'Letter Series', difficulty: 'Medium' },
  { id: 'q-code-1', questionBankId: 'qb-ssc-practice', text: "If CAT is coded as DBU, how is DOG coded in the same language?", options: ['EPH', 'EPI', 'FPH', 'EQH'], answer: 0, explanation: 'Each letter is shifted forward by one: D→E, O→P, G→H, giving EPH.', unit: 'Reasoning', topic: 'Coding-Decoding', difficulty: 'Medium' },
  { id: 'q-code-2', questionBankId: 'qb-ssc-practice', text: "In a certain code, 'PENCIL' is written as 'QFODJM'. How is 'ERASER' written in that code?", options: ['FSBTFS', 'FSATFR', 'ESBTFS', 'FTBSFR'], answer: 0, explanation: "Each letter shifts forward by one, same rule as PENCIL → QFODJM. ERASER → FSBTFS.", unit: 'Reasoning', topic: 'Coding-Decoding', difficulty: 'Hard' },
  { id: 'q-analogy-1', questionBankId: 'qb-ssc-practice', text: 'Doctor is to Hospital as Teacher is to?', options: ['Hospital', 'Clinic', 'School', 'Office'], answer: 2, explanation: 'A doctor works at a hospital; a teacher works at a school. Same relationship.', unit: 'Reasoning', topic: 'Analogy', difficulty: 'Easy' },
  { id: 'q-analogy-2', questionBankId: 'qb-ssc-practice', text: 'Pen is to Write as Knife is to?', options: ['Sharp', 'Cut', 'Kitchen', 'Blade'], answer: 1, explanation: 'A pen is used to write; a knife is used to cut. Same relationship — an object to its primary function.', unit: 'Reasoning', topic: 'Analogy', difficulty: 'Easy' },

  // -- English --
  { id: 'q-vocab-1', questionBankId: 'qb-ssc-practice', text: "Choose the word most similar in meaning to 'Prudent'.", options: ['Careless', 'Wise', 'Rapid', 'Proud'], answer: 1, explanation: "'Prudent' means acting with careful thought; 'Wise' is the closest meaning.", unit: 'English', topic: 'Vocabulary', difficulty: 'Easy' },
  { id: 'q-vocab-2', questionBankId: 'qb-ssc-practice', text: "Choose the antonym of 'Ancient'.", options: ['Old', 'Modern', 'Historic', 'Antique'], answer: 1, explanation: "'Ancient' means very old; its opposite is 'Modern'.", unit: 'English', topic: 'Vocabulary', difficulty: 'Easy' },
  { id: 'q-vocab-3', questionBankId: 'qb-career-english', text: "Choose the synonym of 'Meticulous'.", options: ['Careless', 'Careful', 'Quick', 'Lazy'], answer: 1, explanation: "'Meticulous' means showing great attention to detail — closest in meaning to 'Careful'.", unit: 'English', topic: 'Vocabulary', difficulty: 'Medium' },
  { id: 'q-gram-1', questionBankId: 'qb-career-english', text: 'Choose the correctly spelled word.', options: ['Recieve', 'Receive', 'Receve', 'Receeve'], answer: 1, explanation: "The correct spelling follows 'i before e except after c' — here it is 'Receive'.", unit: 'English', topic: 'Grammar', difficulty: 'Easy' },
  { id: 'q-gram-2', questionBankId: 'qb-career-english', text: 'Identify the grammatically correct sentence.', options: ["He don't like tea.", "He doesn't likes tea.", "He doesn't like tea.", 'He not like tea.'], answer: 2, explanation: "Third-person singular ('He') takes 'doesn't' followed by the base verb 'like'.", unit: 'English', topic: 'Grammar', difficulty: 'Medium' },

  // -- General Awareness --
  { id: 'q-gk-1', questionBankId: 'qb-railway-gs', text: "Who is known as the 'Father of the Indian Constitution'?", options: ['Mahatma Gandhi', 'Jawaharlal Nehru', 'B. R. Ambedkar', 'Sardar Patel'], answer: 2, explanation: 'Dr. B. R. Ambedkar chaired the Constitution Drafting Committee and is regarded as its chief architect.', unit: 'General Awareness', topic: 'Polity', difficulty: 'Easy' },
  { id: 'q-gk-2', questionBankId: 'qb-railway-gs', text: 'What is the currency of Japan called?', options: ['Won', 'Yen', 'Yuan', 'Ringgit'], answer: 1, explanation: "Japan's official currency is the Yen.", unit: 'General Awareness', topic: 'General Knowledge', difficulty: 'Easy' },
  { id: 'q-gk-3', questionBankId: 'qb-railway-gs', text: 'Which is the longest river in India?', options: ['Yamuna', 'Godavari', 'Ganga', 'Brahmaputra'], answer: 2, explanation: 'The Ganga is the longest river flowing within India.', unit: 'General Awareness', topic: 'Geography', difficulty: 'Easy' },
